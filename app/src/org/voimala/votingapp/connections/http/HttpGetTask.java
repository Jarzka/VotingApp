...
class HttpGetTask extends AsyncTask<String, String, AaniHttpResponse> {
    
    private HttpNetworkListener httpNetworkListener = null;
    private final Logger logger = Logger.getLogger(getClass().getName());
    
    public HttpGetTask(final HttpNetworkListener httpNetworkListener) {
    ...
    protected void onPostExecute(final AaniHttpResponse httpResponse) {
        ...
        if (httpNetworkListener != null) {
            if (httpResponse != null) {
                httpNetworkListener.httpRequestCompleted(httpResponse, HttpRequestType.GET);  
            } else {
                httpNetworkListener.httpRequestFailedUnableToConnect(HttpRequestType.GET);
            }
        }
    }
