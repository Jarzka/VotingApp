...
public class UpcomingVotingAdapter extends BaseAdapter {
    
    private Voting voting = null;
    private Context context = null;
    
    public UpcomingVotingAdapter(final Context context, final Voting voting) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.listitem_upcoming_voting_option, null);
